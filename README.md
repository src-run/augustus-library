...
# [src-run] augustus-library

|       Travis-CI        |      Codacy Rating      |      Code Coverage      |        Style-CI         |
|:----------------------:|:-----------------------:|:-----------------------:|:-----------------------:|
| [![Travis](https://src.run/augustus-library/travis.svg)](https://src.run/augustus-library/travis) | [![Codacy](https://src.run/augustus-library/codacy.svg)](https://src.run/augustus-library/codacy) | [![Coveralls](https://src.run/augustus-library/coveralls.svg)](https://src.run/augustus-library/coveralls) | [![Coveralls](https://src.run/augustus-library/styleci.svg)](https://src.run/augustus-library/styleci) |


## Overview

[Welcome](https://src.run/go/readme_welcome)!
The `src-run/augustus-library` package provides the following
...
[augustus group](https://src.run/augustus-library/group), which is a collection of packages with a focus
on "core reflection base classes" and related functionality.

You are welcome to research some [useless details](https://src.run/augustus-library/group_explanation)
...
- [Collaborators](https://src.run/augustus-library/github_collaborators)
...
```json
require: {
	"src-run/augustus-library": "dev-master"
}
```
...
To report issues or request a new feature, use the [project issue tracker](https://src.run/augustus-library/github_issues).
...
our [CONTRIBUTING.md](https://src.run/augustus-library/contributing) file are the only limitations.
...
Review the [LICENSE](https://src.run/augustus-library/license) file distributed with this source code for additional
information.
...
| Item               | Result/Status                                                                                                      |
|-------------------:|:-------------------------------------------------------------------------------------------------------------------|
| __Stable Release__ | [![Packagist](https://src.run/augustus-library/packagist.svg)](https://src.run/augustus-library/packagist)     |
| __Dev Release__    | [![Packagist](https://src.run/augustus-library/packagist_pre.svg)](https://src.run/augustus-library/packagist) |
| __License__        | [![License](https://src.run/augustus-library/license.svg)](https://src.run/augustus-library/license)           |
| __Reference__      | [![License](https://src.run/augustus-library/api.svg)](https://src.run/augustus-library/api)                   |
